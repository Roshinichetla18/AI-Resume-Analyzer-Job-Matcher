  ...
  return (
    <div style={styles.page}>
        ...
        {tab === "history" && (
          <div style={styles.content} className="content">
            ...
            {histLoading ? (
              ...
              <div style={styles.histGrid} className="hist-grid">
                {history.map((item, i) => (
      ...
      <nav className="mobile-bottomnav">
        <button
          className={`mobile-navbtn ${tab === "upload" ? "mobile-navbtn--active" : ""}`}
          onClick={() => setTab("upload")}
        >
          <span className="mobile-navbtn__icon">📄</span>
          <span className="mobile-navbtn__label">Analyze</span>
        </button>
        <button
          className={`mobile-navbtn ${tab === "history" ? "mobile-navbtn--active" : ""}`}
          onClick={() => setTab("history")}
        >
          <span className="mobile-navbtn__icon">📊</span>
          <span className="mobile-navbtn__label">History</span>
        </button>
      </nav>
    </div>
  );
...
const css = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media (max-width: 640px) {
    ...
    /* Stack page vertically: topbar / main / bottom nav */
    .main {
    ...
    .mobile-navbtn__icon { font-size: 20px; }

    .mobile-navbtn__label {
      font-size: 11px;
      font-weight: 400;
      color: #888;
    }

    .mobile-navbtn--active .mobile-navbtn__label {
      color: #2563eb;
      font-weight: 500;
    }
    ...
    /* Drop zone: less vertical padding on mobile */
    .drop-zone {
      padding: 36px 20px !important;
    }

    /* Result grid: single column on mobile */
    .result-grid {
...
const styles = {
  ...
  fileName: { fontSize: 15, fontWeight: 500, color: "#1a1a1a", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
